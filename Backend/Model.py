...
ChatHistory = [
    ...
    {"role" : "User", "message" : "opne chrome and tell me about mahatma gandhi."},
    {"role" : "Chatbot", "message" : "open chrome, general tell me about mahatma gandhi."},
    {"role" : "User", "message" : "open chrome and firefox"},
    {"role" : "Chatbot", "message" : "open chrome, open firefox"},
    {"role" : "User", "message" : "what is today's date and by the way remine me that i have dancing performance on 5th aug at 11pm"},
    {"role" : "Chatbot", "message" : "general what is today's date, reminder 11:00pm 5th aug dancing perfromance"},
    {"role" : "User", "message" : "chat with me"},
    {"role" : "Chatbot", "message" : "general chat with me"},
]

# Define main functions for decision-making on queries
def FirstLayerDMM(prompt: str = "test"):
    ...
    stream = co.chat_stream(
        ...
        message=prompt,  # pass the user's query to the model
        ...
        preamble=preamble,  # pass the preamble to guide the model
    )

    # Initiate an empty string to store the generated response
    response = ""
    ...
    # Strip leading/trailing whitespace from each response
    response = [i.strip() for i in response]

    # Initiate and empty list to filter valid tasks.
    temp = []
    ...
    for task in response:
        for func in funcs:
            if task.startswith(func):
                temp.append(task)  # add valid tasks to the filter
...
if __name__ == "__main__":
 while True:
        user_input = input(">>> ")
        print(f"Processing your query: {user_input}")
        response = FirstLayerDMM(user_input)  # Process input through the model
