...
# Replace the language settings in HTML Code for speech recognition interface
...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "why", "which", "when", "whose", "whom", "can you", "what's", "how's"]
...
# Function to perform speech recognition using the web driver
        ...
        try:
            ...
            if Text:
                ...
                if InputLanguage.lower() == "en" or "en" in InputLanguage.lower():
                    ...
                    # If the input language is not English, translate text and return it
